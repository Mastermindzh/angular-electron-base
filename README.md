...
## Theming
This branch contains the bootstrap theme, to see all theme options check out the [master](https://github.com/Mastermindzh/angular-electron-base/commits/master) branch
